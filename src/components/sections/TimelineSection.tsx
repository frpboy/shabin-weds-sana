...
export default function TimelineSection() {
  ...
  return (
    <SectionContainer id="timeline" className="relative z-10 pt-0 md:pt-2 pb-2 md:pb-4">
      ...
      <div className="relative max-w-4xl mx-auto px-4 py-2 md:py-4">
        <motion.div
        ...
        >
          <motion.div variants={FADE_UP} className="w-full">
            <Card variant="glass" className="p-8 md:p-12 text-center hover:border-primary/50 transition-colors shadow-md">
              ...
              <h3 className="font-cinzel text-4xl text-accent font-medium mb-2">
                {event.title}
              </h3>
              <span className="font-poppins text-2xl text-text/70 block mb-6 italic">
                {event.location}
              </span>
              <p className="font-poppins text-lg text-text/80 leading-relaxed font-light max-w-2xl mx-auto">
                {event.desc}
              </p>
            </Card>
          </motion.div>
